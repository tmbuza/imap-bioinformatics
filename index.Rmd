...
edge[penwidth=2, color=grey];
  ...
  1[label = "count16SShared", color = "0.25 0.6 0.85", style="rounded"];
  2[label = "split16SShared", color = "0.62 0.6 0.85", style="rounded"];
  3[label = "make16SShared", color = "0.46 0.6 0.85", style="rounded"];
  4[label = "make_mapping_file", color = "0.17 0.6 0.85", style="rounded"];
  5[label = "get_read_data", color = "0.50 0.6 0.85", style="rounded"];
  6[label = "get16SReferences", color = "0.00 0.6 0.85", style="rounded"];
  7[label = "subsample16SShared", color = "0.04 0.6 0.85", style="rounded"];
  8[label = "rarefy16SReads", color = "0.38 0.6 0.85", style="rounded"];
  9[label = "calc16SAlphaDiversity", color = "0.42 0.6 0.85", style="rounded"];
  10[label = "calc16SBetaDiversity", color = "0.29 0.6 0.85", style="rounded"];
  11[label = "calc16SNMDS", color = "0.33 0.6 0.85", style="rounded"];
  12[label = "calc16SPCoA", color = "0.54 0.6 0.85", style="rounded"];
  13[label = "calc16SError", color = "0.08 0.6 0.85", style="rounded"];
  14[label = "get16SMock", color = "0.21 0.6 0.85", style="rounded"];
  7 -> 0
  13 -> 0
  10 -> 0
  1 -> 0
...
![](dags/detailed_imap2.svg)
<img src="dags/imap2.svg">
...
## Mothur Bioinformatics snakemake graph<br>
```{r mothur}
library(DiagrammeR)
library(DiagrammeRsvg)
...
subgraph  iMAP 2: BIOINFORMATICS WORKFLOW

0{<center>BIOINFORMATICS OUTPUT</center>}
1[count16SShared]
2[split16SShared]
3[make16SShared]
4[get16SReferences]
5[subsample16SShared]
6[rarefy16SReads]
7[calc16SAlphaDiversity]
8[calc16SBetaDiversity]
9[calc16SNMDS]
10[calc16SPCoA]
11[calc16SError]
12[get16SMock]
