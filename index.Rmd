---
title:  "<big><u>IMAP-PART 05</u></big><br><br>Microbial profiling using Mothur pipeline with Snakemake workflows<br><br>"
subtitle: |
  | ![](images/16srrna.png)<br>
  | Fostering Reproducible Microbiome data Analysis with Snakemake workflow
date:
- IMAP-PART 05<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-bioinformatics-mothur/)<br>
...
github_repo: "https://github.com/tmbuza/imap-bioinformatics-mothur"
description: |
...
A tentative snakemake workflow that defines **mothur bioinformatics rules** in a DAG (directed acyclic graph) format. 
A detailed interactive snakemake HTML report is available [here](https://complexdatainsights.com/imap/imap-bioinformatics-mothur/report.html). Use a wider screen to get a better interactive snakemake report.
