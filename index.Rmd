...
date:
- IMAP-PART 05<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-read-quality-control/)<br>
...
```{r child='workflow/01_download_references.Rmd'}
```

<br>

```{r child='02_taxonomic_classification.Rmd'}
```

<br>

```{r child='03_preliminary_otu_analysis.Rmd'}
```
